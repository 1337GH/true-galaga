...
sprites.onOverlap(SpriteKind.shooter, SpriteKind.DeadZone, function (sprite, otherSprite) {
    sprite.destroy()
    info.changeLifeBy(-1)
})
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.DeadZone, function (sprite, otherSprite) {
    sprite.destroy()
    info.changeLifeBy(-1)
})
function attack () {
